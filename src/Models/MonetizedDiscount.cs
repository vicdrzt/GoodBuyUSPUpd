...
{
    internal class MonetizedDiscount //monetization discounts
    {
        public int ClientId { get; set; } // int not null   ->tclient.clientid

        [Precision(16, 2)]
        public decimal SummPay { get; set; }   // dec() not null - сумма оплаты, может быть только ПОЛОЖИТЕЛЬНОЙ отрицательные величины будут отброшены
